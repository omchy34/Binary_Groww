    ...
    <>
      <style>{`
        ...
        .f-contact-email {
          ...
          transition: color 0.2s; margin-bottom: 22px;
          display: block;
        }
        ...
        .f-sub-input::placeholder { color: rgba(254,252,232,0.2); }
        .f-sub-btn {
          padding: 10px 18px;
          ...
          color: #0a0800; letter-spacing: -0.01em;
        ...
        .f-nav-link:hover { color: var(--accent3); transform: translateX(4px); }
        ...
        .f-divider-line {
          height: 1px;
          background: linear-gradient(90deg, transparent, rgba(245,158,11,0.2), rgba(245,158,11,0.08), transparent);
        }
        ...
        .f-copy em { font-style: normal; color: rgba(245,158,11,0.45); }
        ...
        @media (max-width: 900px) {
          .f-top { grid-template-columns: 1fr 1fr; gap: 40px; padding: 48px 24px 36px; }
          ...
          <div className="f-brand">
            ...
            {subbed ? (
              ...
              <div className="f-sub-box">
                ...
                />
                <button className="f-sub-btn" onClick={handleSubscribe}>Subscribe</button>
              </div>
            )}
          </div>
